		...
		{
			{
				...
				{
					{ "显示鼠标指针(&M)",                ID_MOUSE_CURSOR,          ITEM_CHECKBOX                     },
					{ "仅捕获窗口客户区(&C)",            ID_ONLY_CLIENT_AREA,      ITEM_CHECKBOX                     },
			...
			},
			{
				...
				.Items = (Config__DialogItem[])
				{
					...
					{ "完成后打开文件夹(&P)",         ID_OPEN_FOLDER,    ITEM_CHECKBOX                   },
					{ "分段 MP4 (仅H264)(&4)", ID_FRAGMENTED_MP4, ITEM_CHECKBOX                   },
			...
			},
			{
				...
				.Items = (Config__DialogItem[])
				{
					{ "伽马校正缩放(&G)",      ID_VIDEO_GAMMA_RESIZE ,    ITEM_CHECKBOX     },
					{ "改善的颜色转换(&I)", ID_VIDEO_IMPROVED_CONVERT, ITEM_CHECKBOX     },
					{ "编码器",                      ID_VIDEO_CODEC,            ITEM_COMBOBOX, 64 },
					{ "配置文件",                    ID_VIDEO_PROFILE,          ITEM_COMBOBOX, 64 },
					...
					{ "比特率 (kbit/s)",           ID_VIDEO_BITRATE,          ITEM_NUMBER,   64 },
					{ NULL },
				},
			},
			{
				...
				.Items = (Config__DialogItem[])
				{
					{ "录制音频(&D)",           ID_AUDIO_CAPTURE,           ITEM_CHECKBOX     },
					{ "应用程序本地音频(&N)", ID_AUDIO_APPLICATION_LOCAL, ITEM_CHECKBOX     },
					{ "编码器",                    ID_AUDIO_CODEC,             ITEM_COMBOBOX, 60 },
					{ "声道",                 ID_AUDIO_CHANNELS,          ITEM_COMBOBOX, 60 },
					{ "采样率",               ID_AUDIO_SAMPLERATE,        ITEM_COMBOBOX, 60 },
					{ "比特率 (kbit/s)",         ID_AUDIO_BITRATE,           ITEM_COMBOBOX, 60 },
					{ NULL },
				},
			},
			{
				...
				.Items = (Config__DialogItem[])
				{
					{ "捕获显示器", ID_SHORTCUT_MONITOR, ITEM_HOTKEY, 64 },
					{ "捕获窗口",  ID_SHORTCUT_WINDOW,  ITEM_HOTKEY, 64 },
					{ "捕获区域",  ID_SHORTCUT_REGION,  ITEM_HOTKEY, 64 },
					{ NULL },
				},
			},
			{ NULL },
